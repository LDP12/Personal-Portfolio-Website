...
const socialLinks = [
  {
    href: 'https://www.github.com/LDP12',
  ...
  {
    href: 'https://www.linkedin.com/in/luke-penney-5694a7204/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://x.com/LukeDanPenney',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/lukedpenney',
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Reach out today to discuss your project needs and let&apos;s build you something amazing!
          </p>
        ...
        <form
            action="https://getform.io/f/bjjjlxwb"
            method="POST"
        ...
        >
          ...
          <div className="mb-4">
            ...
            <textarea
                name="message"
                id="message"
                placeholder="Hi, I'd like to propose a potential work opportunity!"
                required
                className="text-field resize-y min-h-32 max-h-80 reveal-up"
            ></textarea>
          </div>

          {/* Hidden Honeypot Field - To help prevent spam */}
          <input
              type="hidden"
              name="_gotcha"
              style={{display: "none"}}
          ...
          <div className="mb-4">
            <label className="label">Subscribe To Potential Updates</label>
            <div>
              <input
                  type="hidden"
                  name="subscribe"
